...
- [firmware/bsp/esp32-s3-epaper-1.54-v2](firmware/bsp/esp32-s3-epaper-1.54-v2/)

板级自检应用：

- [firmware/apps/board_smoke_test](firmware/apps/board_smoke_test/)

自定义综合程序：

- [firmware/apps/factory_program_custom](firmware/apps/factory_program_custom/)

官方例程保持原样，存放在 `firmware/official/v2/esp-idf/`，作为 BSP 行为参考。

## 仓库结构

- `docs/`: 官方介绍、项目文档和开发记录
- `firmware/`: 固件源码与官方例程；当前已导入 [官方 ESP-IDF V2 例程](firmware/official/v2/esp-idf/README.md)
