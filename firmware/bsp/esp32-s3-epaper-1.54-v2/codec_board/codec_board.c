...
void set_codec_board_type(const char *codec_type)
{
    ...
    if (codec_type && strcmp(codec_type, "S3_ePaper_1_54") == 0) {
        static board_section_t board = {
            .i2c_pin = {
                {
            ...
            .i2s_pin = {
                {
                    ...
                    .bclk = BOARD_I2S_SCLK_PIN,
                    .ws = BOARD_I2S_LRCK_PIN,
                    .dout = BOARD_I2S_ASDOUT_PIN,
                    .din = BOARD_I2S_DSDIN_PIN,
                },
            },
            .codec = {
                {
    ...
    ESP_LOGE(TAG, "Unsupported codec board type: %s", codec_type ? codec_type : "(null)");
}
